...
layer = 1
layer_shape = (ngf*2*2*2*2, img_size/(2*2*2*visible_subsamp), img_size/(2*2*2*visible_subsamp))

experiment = geth_experiment('src.model_32x_sub_widelayer1', process_data, layer, layer_shape)
experiment.run()
