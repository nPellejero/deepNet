...
from lib.ops import batchnorm, running_batchnorm, conv_cond_concat, deconv, dropout, l2normalize
...
class GAN_model(Model):
    ...
    def __init__(self, gen_dim = 100, ngf = 128, ndf = 128, nchannels = 3, init_scale=0.02, bn_momentum=0.9):
        ...
        gw  = gifn((gen_dim, ngf*8*4*4), 'gw')
        gg = gain_ifn((ngf*8*4*4), 'gg')
        gb = bias_ifn((ngf*8*4*4), 'gb')
        gu = bnmean_fn((ngf*8*4*4), 'gu')
        gs = bnstd_fn((ngf*8*4*4), 'gs')
        ...
        gwx = gifn((ngf, nchannels, 5, 5), 'gwx')

        dw  = difn((ndf, nchannels, 5, 5), 'dw')
        ...
        self.trainable_classif_params = [dw, dw2, dg2, db2, dw3, dg3, db3, dw4, dg4, db4, dwc]

        self.gen_params = [gw, gg, gb, gu, gs, gw2, gg2, gb2, gu2, gs2,
                           gw3, gg3, gb3, gu3, gs3, gw4, gg4, gb4, gu4, gs4, gwx]
        self.disclass_params = [dw, dw2, dg2, db2, du2, ds2, dw3, dg3, db3, du3, ds3, dw4, dg4, db4, du4, ds4, dwy, dwc]
        self.discrim_params = [dw, dw2, dg2, db2, du2, ds2, dw3, dg3, db3, du3, ds3, dw4, dg4, db4, du4, ds4, dwy]
        self.classif_params = [dw, dw2, dg2, db2, du2, ds2, dw3, dg3, db3, du3, ds3, dw4, dg4, db4, du4, ds4, dwc]
    ...
    def gen_function(self, test_mode, Z, w, g, b, u, s, w2, g2, b2, u2, s2, w3, g3, b3, u3, s3, w4, g4, b4, u4, s4, wx):
        x1, updates1 = running_batchnorm(T.dot(Z, w), g=g, b=b, running_u=u, running_s=s, momentum=self.bn_momentum,
                                         test_mode=test_mode)
        h = relu(x1)
        h = h.reshape((h.shape[0], self.ngf*8, 4, 4))
    ...
    def discrim_function(self, test_mode, X, w, w2, g2, b2, u2, s2, w3, g3, b3, u3, s3, w4, g4, b4, u4, s4, wy, wc):
        ...
        c = softmax(T.dot(h5, wc))
        return y, c, updates2 + updates3 + updates4
