...
dataPathCrop = commPath+'cohn-kanade-images-canonical/'
txtPath  = commPath+'redes/txtFiles/BDtxtCohnKanadeCanonical/'
masterCount = 0
maxIm = 255
maxLabs = 100
numLab = 0
